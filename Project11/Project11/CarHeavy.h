...
public:
	...
	CarHeavy() { price = 0; speed = 0; ID = 0; index = 1; };
	// конструктор копирование
	CarHeavy(const CarHeavy& obj);
	// конструктор с параметрами
	CarHeavy(int _ID, char* _model, char* _marka, int _price, int _speed, int _index, char* _type);
	...
	friend ostream& operator<<(ostream& out, const CarHeavy& obj);
	// оператор присваивание
	CarHeavy& operator= (const CarHeavy& other);
	// деструктор
	~CarHeavy() {}
};
